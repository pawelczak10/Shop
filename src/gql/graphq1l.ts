...
export type CreateProductReviesMutationVariables = Exact<{
  review: ReviewCreateInput;
}>;


export type CreateProductReviesMutation = { __typename?: 'Mutation', review?: { __typename?: 'Review', id: string, stage: Stage } | null };

export type ProductQueryVariables = Exact<{ [key: string]: never; }>;


export type ProductQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', id: string, slug: string, name: string, price: number, images: Array<{ __typename?: 'Asset', url: string }> }> };
...
export type GetProductDetailsQuery = { __typename?: 'Query', product?: { __typename?: 'Product', name: string, price: number, description: string, images: Array<{ __typename?: 'Asset', url: string }> } | null };

export type ProductIdQueryVariables = Exact<{ [key: string]: never; }>;


export type ProductIdQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', id: string }> };

export type ReviewContentFragment = { __typename?: 'Review', content: string, headline: string, id: string, name: string, rating?: number | null } & { ' $fragmentName'?: 'ReviewContentFragment' };
...
export type GetReviewsForProductSlugQuery = { __typename?: 'Query', product?: { __typename?: 'Product', reviews: Array<(
      { __typename?: 'Review' }
      & { ' $fragmentRefs'?: { 'ReviewContentFragment': ReviewContentFragment } }
    )> } | null };

export const ReviewContentFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"reviewContent"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Review"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"headline"}},{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"rating"}}]}}]} as unknown as DocumentNode<ReviewContentFragment, unknown>;
...
export const GetReviewsForProductSlugDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetReviewsForProductSlug"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"slug"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"product"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"slug"},"value":{"kind":"Variable","name":{"kind":"Name","value":"slug"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"reviews"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"reviewContent"}}]}}]}}]}},...ReviewContentFragmentDoc.definitions]} as unknown as DocumentNode<GetReviewsForProductSlugQuery, GetReviewsForProductSlugQueryVariables>;